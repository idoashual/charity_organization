...
let debug = require('debug')('charity-organization:app'); // add using the debugger tool
...
(async () => {
    ...
    let sessConnStr = "mongodb://127.0.0.1/charity-organization-sessions";
    ...
    let secret = 'charity organization secret'; // must be the same one for cookie parser and for session
